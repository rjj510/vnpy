...
import vnpy.trader.app.ctaStrategy.strategy.strategy_AttackDay_RB as ADRB
#----------------------------------------------------------------------
def calculateDailyResult_init():
    ...
    # 在引擎中创建策略对象
    d = {}
    engine.initStrategy(ADRB.strategy_AttackDay_RB, d)
    return engine
...
def get_strategy_init_days(engine):
    return engine.strategy.SK_A_LONG+engine.strategy.SK_E_LONG  
